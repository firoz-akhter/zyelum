const SubNavbar = () => {
  return (
    <div className="h-12 bg-blue-900 text-white w-full overflow-x-auto overflow-y-hidden">
      <div className="flex items-center space-x-2 px-2 min-w-max h-full">
        {/* All Categories */}
        <div className="relative group inline-block h-full">
          {/* Dropdown Button */}
          <button className="flex items-center text-white px-2 py-2 rounded-md text-xs whitespace-nowrap h-full">
            <span className="bg-gray-200 rounded-full p-1 mr-1">
              <svg
                width="8"
                height="8"
                viewBox="0 0 13 13"
          ...
          {/* Dropdown Menu */}
          <div className="absolute left-0 mt-0 w-78 bg-white border border-gray-200 rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 pointer-events-none group-hover:pointer-events-auto z-50">
            <button
