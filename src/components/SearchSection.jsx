  ...
  return (
    <div>
      <div className="flex flex-col items-start h-[400px] md:h-[600px] w-full bg-[url('https://d86af0gufpxog.cloudfront.net/unsafe/adaptive-fit-in/1200x600/filters:format(webp)/https%3A%2F%2Fd5nfy7n2jvqm2.cloudfront.net%2Fbuyerfe%2FlandingImage.png')] bg-fixed bg-cover bg-center bg-no-repeat">
        ...
        <div className="flex flex-col md:flex-row items-center bg-white rounded-none md:!rounded-[9999px] p-2 md:p-1 w-[90%] md:w-[55%] mx-4 md:mx-10 mt-6 md:mt-10">
          ...
          <button className="cursor-pointer w-full md:w-auto mt-2 md:mt-0 bg-gradient-to-r from-teal-400 to-blue-500 text-white text-lg md:text-xl px-4 md:px-8 py-3 md:py-4 rounded-none md:!rounded-[9999px] font-bold md:self-stretch">
            Search
          </button>
        </div>
        ...
        <div className="hidden md:flex items-center rounded-4xl p-1 w-[60%] ml-10 mt-5">
          <div className="flex space-x-2 w-full overflow-x-auto py-2 scrollbar-hide">
            <button className="py-2 px-5 me-2 mb-2 text-sm font-medium text-white focus:outline-none rounded-none md:!rounded-[9999px] border hover:bg-black/20 hover:bg-opacity-20 cursor-pointer whitespace-nowrap">
              Aluminium Ingots
            </button>
            <button className="py-2 px-5 me-2 mb-2 text-sm font-medium text-white focus:outline-none rounded-none md:!rounded-[9999px] border hover:bg-black/20 hover:bg-opacity-20 cursor-pointer whitespace-nowrap">
              Bitumen
